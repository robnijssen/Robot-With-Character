...
class Variables:
    ...
    left_joint_values = list(start_joint_values)
    right_joint_values = list(start_joint_values)
...
class Functions:
    def calculate_joint_values(self):
        ...
        rospy.logwarn(correction_0)#
        rospy.logwarn(correction_1)#
        rospy.logwarn(correction_2)#
        rospy.logwarn(correction_3)#
        rospy.logwarn(correction_4)#
        # set approximated pitch
        tmp = correction_2 - correction_1 - correction_3
        happyWiggleVariables.start_joint_values[3] += tmp
        happyWiggleVariables.left_joint_values[3] += tmp
        happyWiggleVariables.right_joint_values[3] += tmp
        # set approximated yaw
        tmp = correction_4 + correction_0
        happyWiggleVariables.start_joint_values[0] -= tmp
        happyWiggleVariables.left_joint_values[0] -= tmp
        happyWiggleVariables.right_joint_values[0] -= tmp
        # alter some yaw values
        ...
        # make sure the yaw rotation won't go out of bounds
