...
"""
This stays in idle, till it's commanded to do something by the /cmd_play
It will look for and then pick dice and put them in the cup.
"""
...
class Variables:
    ...
    cmd_idle = 0
    # joint values where to pick the dice
    dice_1_joint_values = [-2.2938314119922083, -1.116389576588766, -2.527221981679098, 0.5780388116836548, -4.732337776814596, -3.170588795338766]
    dice_2_joint_values = [-2.2938314119922083, -1.116389576588766, -2.527221981679098, 0.5780388116836548, -4.732337776814596, -3.170588795338766]
